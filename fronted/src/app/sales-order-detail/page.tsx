...
export default function SalesOrderDetailsPage() {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      setMessage(
        editingDetail
          ? "Sales order detail updated successfully."
          : "Sales order detail added successfully.",
      );
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      ...
      setMessage(
        "Sales order detail deleted successfully.",
      );
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-slate-500">
                  Manage products, quantities, and pricing for sales orders.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6 flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                {editingDetail
                  ? "Update the selected sales order line item."
                  : "Add a product line to an existing sales order."}
              </p>
            </div>
          ...
          <div className="rounded-xl border border-slate-100 bg-white p-12 text-center shadow-sm">
            ...
            <p className="mt-2 text-sm text-slate-500">
              {search
                ...
                : "Add your first sales order detail to get started."}
            </p>
            ...
            <div className="flex items-center justify-between border-b border-slate-100 px-6 py-4">
              <div>
                ...
                <p className="mt-1 text-xs text-slate-400">
                  Products assigned to sales orders
                </p>
              </div>
            </div>
